...
>
    ...
    <nav class="space-y-2">
        ...
        <div>
            ...
            <a href="{{ route('admin.moderation.contents') }}" class="flex items-center space-x-2 py-2.5 px-4 rounded transition duration-200 sidebar-link {{ request()->routeIs('admin.moderation.answers') ? 'active' : '' }}">
