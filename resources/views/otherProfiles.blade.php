...
<div class="text-[var(--text-primary)] min-h-screen p-4 sm:p-6 lg:p-8 max-w-[70rem] mx-auto profile-container">
    ...
    <div class="w-full rounded-xl shadow-lg overflow-hidden profile-card">
        <div class="bg-gradient-to-r from-[#38A3A5] to-[#80ED99] h-32 sm:h-48 relative">
            <div class="absolute -bottom-16 left-1/2 transform -translate-x-1/2 sm:-bottom-16 sm:left-8 sm:transform-none">
                <img src="{{  $user['image'] ? asset('storage/' .  $user['image']) : 'https://via.placeholder.com/100' }}" alt="Profile Picture" 
        ...
        <div class="pt-20 sm:pt-6 sm:pl-48 px-4 sm:px-8 pb-6">
            <div class="flex flex-col sm:flex-row justify-between items-center sm:items-start">
                <div class="text-center sm:text-left mb-4 sm:mb-0">
                    <h2 class="text-[var(--text-primary)] text-3xl font-bold cal-sans-regular">{{ $user['username'] }}</h2>
                </div>
        ...
        <div class="bg-[var(--bg-card-hover)] px-6 py-4 flex justify-around border-t border-b border-[var(--border-color)]">
            <div class="text-center">
                <h3 id="countFollowers" class="text-[var(--profile-primary)] text-xl font-bold">
                    {{ $countFollowers }}
                </h3>
                <p class="text-[var(--text-muted)] text-sm">Followers</p>
            </div>
            <div class="text-center">
                <h3 class="text-[var(--profile-primary)] text-xl font-bold">0</h3>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 mt-8">
        ...
        <div class="col-span-1 lg:col-span-3 space-y-6">
            ...
            <!-- Stats Section -->
            <div class="profile-card p-6">
                <h3 class="text-[var(--profile-primary)] text-xl font-bold mb-4 cal-sans-regular">Stats</h3>
                <div class="space-y-3">
                    <div class="flex justify-between items-center">
                        <span class="text-[var(--text-secondary)]">Reputation</span>
                        <span class="font-bold text-[var(--profile-primary)]">0</span>
                    </div>
                    <div class="flex justify-between items-center">
                ...
                <div class="space-y-4">
                    <div class="profile-post p-4 rounded-lg">
                        <div class="flex items-start">
                            <div class="flex-1">
                                <a href="#" class="text-[var(--profile-primary)] font-medium hover:underline text-lg">
                                    How does JVM Clojure store captured environments of closures under the hood?
                                </a>
                                <div class="flex flex-wrap gap-2 mt-2 mb-3">
                                    <span class="profile-tag px-2 py-0.5 text-white text-xs rounded">clojure</span>
                                    <span class="profile-tag px-2 py-0.5 text-white text-xs rounded">jvm</span>
                                    <span class="profile-tag px-2 py-0.5 text-white text-xs rounded">closures</span>
                                </div>
