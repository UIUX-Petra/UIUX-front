    ...
    <div
        ...
        <div class="flex flex-col z-10">
            ...
            <div class="flex space-x-4 mt-4">
                <button
                    class="px-3 py-1 rounded-full bg-[rgba(245,158,11,0.2)] text-[#f59e0b] text-sm font-medium hover:bg-[rgba(245,158,11,0.3)] transition-colors">Today</button>
                <button
                    class="px-3 py-1 rounded-full bg-transparent text-[var(--text-muted)] text-sm font-medium hover:bg-[rgba(245,158,11,0.1)] transition-colors">This
                    Week</button>
                <button
                    class="px-3 py-1 rounded-full bg-transparent text-[var(--text-muted)] text-sm font-medium hover:bg-[rgba(245,158,11,0.1)] transition-colors">This
                    Month</button>
                <button
                    class="px-3 py-1 rounded-full bg-transparent text-[var(--text-muted)] text-sm font-medium hover:bg-[rgba(245,158,11,0.1)] transition-colors">All
                    Time</button>
            </div>
        </div>
    </div>
