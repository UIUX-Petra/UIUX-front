...
@include('partials.nav')
    ...
    <div class="absolute -right-20 -top-20 w-64 h-64 rounded-full bg-gradient-to-br from-[rgba(56,163,165,0.2)] to-[rgba(128,237,153,0.2)] blur-2xl pointer-events-none"></div>
    <div class="absolute -left-32 top-96 w-48 h-48 rounded-full bg-gradient-to-br from-[rgba(128,237,153,0.15)] to-[rgba(56,163,165,0.15)] blur-xl pointer-events-none"></div>
    ...
    <div class="w-full rounded-lg p-6 px-8 max-w-5xl items-start justify-start my-6 relative z-10">
        <div class="relative z-10">
            ...
            <p class="text-[var(--text-secondary)] text-md lg:text-lg pl-0.5 font-regular leading-relaxed max-w-4xl">
                ...
                programs at Petra Christian University. Connect with fellow students and dive deep into your academic interests.
            </p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-5xl items-start justify-start px-6">
        @if(isset($tags) && count($tags) > 0)
            @foreach ($tags as $index => $tag)
                <div class="tag-card fade-in shadow-lg rounded-xl p-6 bg-[var(--bg-card)] border border-[var(--border-color)] relative overflow-hidden transition-all duration-300 hover:transform hover:-translate-y-2 hover:scale-105 hover:shadow-xl hover:border-[var(--accent-tertiary)] hover:bg-[var(--bg-card-hover)]">
                    ...
                    <div class="text-sm my-4 text-[var(--text-muted)] leading-relaxed">
                        <p>{{ $tag['description'] ?? 'Explore questions and discussions related to this subject area.' }}</p>
                    </div>

                    <div class="bg-gradient-to-r from-[rgba(56,163,165,0.08)] to-[rgba(128,237,153,0.08)] border border-[rgba(56,163,165,0.2)] rounded-lg px-3 py-2 inline-flex items-center gap-2">
        ...
        @else
            <div class="col-span-full">
                <div class="text-center py-16 px-8 bg-gradient-to-br from-[rgba(56,163,165,0.05)] to-[rgba(128,237,153,0.05)] border-2 border-dashed border-[var(--border-color)] rounded-2xl my-8">
                    ...
                    <p class="text-[var(--text-secondary)] text-lg">
                        We're currently updating our subject catalog. Please check back soon for exciting academic discussions!
                    </p>
                </div>
            </div>
        @endif
