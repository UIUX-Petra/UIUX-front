    ...
    <div class="min-h-screen p-4 sm:p-6 lg:p-8 edit-profile-container max-w-[68rem] justify-start items-start">
        ...
        <div class="w-full rounded-xl shadow-lg overflow-hidden edit-card mb-6">
            ...
            <div class="bg-gradient-to-r from-[#38A3A5] to-[#80ED99] h-32 sm:h-48 relative">
                ...
                <button
                    class="absolute bottom-4 right-4 px-3 py-1.5 bg-[var(--bg-)] rounded-lg shadow-md text-sm text-[var(--text-primary)] flex items-center hover:bg-[var(--bg-card-hover)]">
            ...
            <div class="relative px-6 py-8">
                ...
                <div class="absolute -top-16 left-1/2 transform -translate-x-1/2 sm:left-8 sm:transform-none">
                    <div class="relative profile-upload group">
                        ...
                        <div
                            class="absolute inset-0 bg-black bg-opacity-50 rounded-full flex items-center justify-center profile-upload-icon">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                ...
                                <div
                                    class="w-11 h-6 border border-[var(--border-color)] bg-[var(--bg-tertiary)] peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-[var(--accent-secondary)]">
                                </div>
                            </label>
                        </div>
                        <div class="flex items-center justify-between">
            ...
            <div class="lg:col-span-8 space-y-6">
                ...
                <div class="edit-card p-6">
                    ...
                    <div class="edit-section">
                        ...
                        <p class="text-sm text-[var(--text-secondary)] mt-2">Write a short bio to introduce yourself to the
                            community</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col sm:flex-row justify-center sm:justify-end gap-4">
                    ...
                    <button type="submit" id="save"
                        class="px-6 py-3 btn-primary text-PRIMARY rounded-lg font-medium transition-all flex items-center justify-center">
            ...
            if (tagsInput) {
                tagsInput.addEventListener('keydown', function(e) {
                    if (e.key === 'Enter' && tagsInput.value.trim() !== '') {
                        ...
                        newTag.innerHTML =
                            `${tagValue} <button class="ml-2 text-white"><i class="fa-solid fa-times"></i></button>`;
                        ...
                        if (data.success) {
                            ...
                            setTimeout((result) => {
                                if (result.isConfirmed) {
                                    window.location.href = "{{ route('viewUser', ['email' => $user['email']]) }}";
                                }
                            }, 3000);
                        } else {
                            Toastify({
